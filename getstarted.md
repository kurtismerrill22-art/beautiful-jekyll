...
<h3 class="heading-one">1. Fork this project</h3>
...
<h3 class="heading-two">2. Rename the project to &lt;yourusername&gt;.github.io</h3>
...
<h3 class="heading-three">3. Customize your website settings</h3>
...
.heading-three {
    ...
    letter-spacing: 2px;
    border-bottom: 3px dashed #2a9d8f;
    padding-bottom: 6px;
}
</style>
